...
The model demonstrated quite a good performance. The accuracy is 89.47% with a Kappa coefficient of 0.7709, which indicates a significant agreement between the model's predictions and the actual observations.

The specificity is as high as 98.55% while the sensitivity is 75.56%, which means that the model performs well in identifying negative cases but is slightly less effective in identifying positive cases.
...
The test results are similar to the previous test set realization, with a high accuracy of 84.06% and a Kappa coefficient of 0.6315, indicating a significant agreement between the predictions and the actual results.

The specificity is high at 96.86%, while the sensitivity is 61.96%, which means that the model performs well in identifying negative examples, but is slightly less effective in identifying positive examples.
