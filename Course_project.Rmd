...
The model demonstrated quite a good performance. The accuracy is 86.84% with a Kappa coefficient of 0.7124, which indicates a significant agreement between the model's predictions and the actual observations.

The specificity is as high as 97.10% while the sensitivity is 71.11%, which means that the model performs well in identifying negative cases but is slightly less effective in identifying positive cases.
...
The test results are similar to the previous test set realization, with a high accuracy of 85.26% and a Kappa coefficient of 0.66, indicating a significant agreement between the predictions and the actual results.

The specificity is high at 97.48%, while the sensitivity is 64.13%, which means that the model performs well in identifying negative examples, but is slightly less effective in identifying positive examples.
